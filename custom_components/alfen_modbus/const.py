...
SOCKET1_SENSOR_TYPES = {
  ...
  "S1_Apparant_Power_PhaseL1": ["S1 Apparant power L1","socket_1_apparentPowerL1" , "VA",  None],
  "S1_Apparant_Power_PhaseL2": ["S1 Apparant power L2","socket_1_apparentPowerL2" , "VA",  None],
  "S1_Apparant_Power_PhaseL3": ["S1 Apparant power L3","socket_1_apparentPowerL3" , "VA",  None],
  "S1_Apparant_Power_Sum": ["S1 Apparant power sum","socket_1_apparentPowerSum" , "VA", None],
  ...
  "S1_Apparant_Energy_Phase_L1": ["S1 Apparant energy L1","socket_1_apparentEnergyL1" , "VAh",    None],
  "S1_Apparant_Energy_Phase_L2": ["S1 Apparant energy L2","socket_1_apparentEnergyL2" , "VAh",    None],
  "S1_Apparant_Energy_Phase_L3": ["S1 Apparant energy L3","socket_1_apparentEnergyL3" , "VAh",    None],
  "S1_Apparant_Energy_Sum": ["S1 Apparant energy sum","socket_1_apparentEnergySum" , "VAh",   None],
...
SOCKET2_SENSOR_TYPES = {
  ...
  "S2_Apparant_Power_PhaseL1": ["S2 Apparant power L1","socket_2_apparentPowerL1" , "VA",  None],
  "S2_Apparant_Power_PhaseL2": ["S2 Apparant power L2","socket_2_apparentPowerL2" , "VA",  None],
  "S2_Apparant_Power_PhaseL3": ["S2 Apparant power L3","socket_2_apparentPowerL3" , "VA",  None],
  "S2_Apparant_Power_Sum": ["S2 Apparant power sum","socket_2_apparentPowerSum" , "VA", None],
  ...
  "S2_Apparant_Energy_Phase_L1": ["S2 Apparant energy L1","socket_2_apparentEnergyL1" , "VAh",    None],
  "S2_Apparant_Energy_Phase_L2": ["S2 Apparant energy L2","socket_2_apparentEnergyL2" , "VAh",    None],
  "S2_Apparant_Energy_Phase_L3": ["S2 Apparant energy L3","socket_2_apparentEnergyL3" , "VAh",    None],
  "S2_Apparant_Energy_Sum": ["S2 Apparant energy sum","socket_2_apparentEnergySum" , "VAh",   None],
